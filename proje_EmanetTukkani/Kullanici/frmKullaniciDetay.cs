	...
	public partial class frmKullaniciDetay : DevExpress.XtraEditors.XtraForm
	{
		...
		private void frmKullaniciDetay_Load(object sender, EventArgs e)
		{
			try
			{
				if (_KullaniciID != "-1")
				{
					using (SqlCommand cmd = new SqlCommand(@"Select KullaniciAdSoyad, KullaniciKodu, KullaniciSifre, Aktif From Kullanici Where KullaniciID=@KullaniciID", CsDosyası.csBaglanti.BaglantiGetir()))
					{
